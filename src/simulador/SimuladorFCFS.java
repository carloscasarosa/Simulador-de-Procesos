...
public class SimuladorFCFS {
    ...
    public SimuladorFCFS(SimulacionProceso simulacionProceso) {
        //this.simulacionProceso = simulacionProceso;
    }
        
    public SimuladorFCFS(){
    }
    
public void simularFCFS(String politica, ArrayList<Proceso> listaDeProcesos, ConfiguracionSistema configuracion){
   ...
   while(procesosPendiente(listaDeProcesos)){
        for(Proceso p : Proceso.listaDeProcesos){
            ...
            while(procesoActual.getEstado().equals("Listo")  && procesoActual.getRafagaCPUrestante() >0 ){
